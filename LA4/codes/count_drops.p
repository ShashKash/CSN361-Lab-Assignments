...
# script to find the amount of packet drops using
# the trace file saved as 1.tr

# works by finding the number of "d"
# which denotes a packet loss
# in the trace file
...
# whatever this is printing will get appended to packet_loss.txt
# rather than being displayed on terminal
while($i<2){
    if($i==0){
        printf("Node 0 to 1\n");
    }else{
